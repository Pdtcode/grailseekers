...
const VideoBackground = ({
            ...
            try {
              ...
              if (playPromise !== undefined) {
                ...
                playPromise.then(() => {
                  ...
                  debugLog("Failed to play video after visibility change", error);
          ...
          try {
            ...
            if (currentPlayPromise) {
              ...
              currentPlayPromise.then(() => {
                ...
                debugLog("Play promise was already rejected, no need to pause");
              });
            } else {
  ...
  const handleManualPlay = () => {
    if (videoRef.current && videoUrl && isVisible) {
      ...
      debugLog("Cannot play manually - video element or URL missing or tab not visible");
    }
  };
    ...
    <div className={`relative w-full h-full min-h-screen overflow-hidden ${className}`}>
      ...
      {!videoLoaded && !videoError && videoUrl && isVisible && (
        <div className="absolute inset-0 flex items-center justify-center bg-gray-900/70 z-20">
          ...
          >
            <div className="animate-pulse text-white text-lg mb-2">Click to play video</div>
      ...
      {videoError && videoUrl && isVisible && (
        <div className="absolute inset-0 flex items-center justify-center bg-gray-900/70 z-20">
          <div className="bg-black/80 p-6 rounded-lg text-center">
            <div className="text-red-500 text-lg mb-2">Video playback error</div>
      ...
      {videoUrl && !videoError ? (
        <video
          ...
          onError={(e) => {
            ...
            if (isVisible) { // Only set error when tab is visible
              setVideoError(true);
            }
          }}
          onCanPlayThrough={() => {
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-gray-900 to-black w-full h-full"></div>
      )}
      
      {/* Dark overlay to ensure content is visible */}
      <div className={`absolute inset-0 bg-black/50 ${overlayClassName}`}></div>
